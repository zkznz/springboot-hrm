...
CREATE TABLE `att_attendance`  (
  ...
  `staff_id` int(0) NULL DEFAULT NULL COMMENT '员工id',
  ...
  `status` tinyint(0) NULL DEFAULT NULL COMMENT '0正常，1迟到，2早退，3旷工，4休假',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `is_deleted` tinyint(0) UNSIGNED NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 196 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工考勤表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `att_leave`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `type_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '休假类型id',
  `dept_id` int(0) NULL DEFAULT NULL COMMENT '部门id',
  `days` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '休假天数',
  `status` tinyint(0) UNSIGNED NULL DEFAULT 1 COMMENT '0禁用，1正常，默认1',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `is_deleted` tinyint(0) UNSIGNED NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '请假表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `att_leave_type`  (
  ...
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0,
  `status` tinyint(0) UNSIGNED NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '请假类型表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `att_overtime`  (
  ...
  `type_id` int(0) NULL DEFAULT NULL COMMENT '加班类型',
  `dept_id` int(0) NULL DEFAULT NULL COMMENT '部门id',
  `count_type` tinyint(0) NULL DEFAULT NULL COMMENT '0小时，1天，默认0，计数加班工资的类型',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `status` tinyint(0) UNSIGNED NOT NULL DEFAULT 1 COMMENT '1启用，0禁用，默认1',
  `is_time_off` tinyint(0) UNSIGNED NULL DEFAULT 0 COMMENT '0不补休，1补休，默认0',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '加班表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `att_overtime_type`  (
  ...
  `status` tinyint(0) UNSIGNED NOT NULL DEFAULT 1 COMMENT '0禁用，1启用，默认1',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `lower_limit` decimal(5, 2) NULL DEFAULT NULL COMMENT '工资倍数下限',
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '加班类型表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `att_staff_leave`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `staff_id` int(0) NULL DEFAULT NULL COMMENT '员工id',
  `days` int(0) NULL DEFAULT NULL COMMENT '请假的天数',
  `type_id` int(0) NULL DEFAULT NULL COMMENT '请假类型id',
  `start_date` date NULL DEFAULT NULL COMMENT '请假的开始日期',
  `status` tinyint(0) UNSIGNED NULL DEFAULT 0 COMMENT '0未审核，1审核通过，2驳回，3撤销',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0,
...
INSERT INTO `att_staff_leave` VALUES (16, 1, 1, 2, '2023-04-10', 2, NULL, '2023-04-09 10:38:00', '2023-04-09 10:50:23', 0);
...
CREATE TABLE `att_work_time`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `dept_id` int(0) UNSIGNED NULL DEFAULT NULL,
  `mor_start_time` time(0) NULL DEFAULT NULL COMMENT '上午上班时间',
  `mor_end_time` time(0) NULL DEFAULT NULL COMMENT '上午下班时间',
  `aft_start_time` time(0) NULL DEFAULT NULL COMMENT '下午上班时间',
  `aft_end_time` time(0) NULL DEFAULT NULL COMMENT '下午下班时间',
  ...
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '工作时间表' ROW_FORMAT = Dynamic;
...
INSERT INTO `att_work_time` VALUES (12, 17, '06:50:00', '10:30:00', '13:20:00', '16:50:00', 7.2, NULL, NULL, NULL, 0);
INSERT INTO `att_work_time` VALUES (13, NULL, '06:10:00', '10:20:00', '13:10:00', '16:40:00', 7.7, NULL, NULL, NULL, 0);
INSERT INTO `att_work_time` VALUES (14, NULL, '06:20:00', '10:10:00', '13:10:00', '16:40:00', 7.3, NULL, NULL, NULL, 0);
...
CREATE TABLE `per_menu`  (
  ...
  `parent_id` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '父菜单id，0代表根菜单，默认0',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `per_menu` VALUES (21, '1', '测试', 'icon', '/icon', 0, NULL, '2023-04-09 10:29:37', '2023-04-09 10:39:24', 1);
INSERT INTO `per_menu` VALUES (22, '2', '测试1', 'ss', '/tt', 21, NULL, '2023-04-09 10:30:13', NULL, 0);
INSERT INTO `per_menu` VALUES (23, '3', 'ce', 'pp', '66', 21, NULL, '2023-04-09 10:39:15', NULL, 0);
INSERT INTO `per_menu` VALUES (24, '6', '测试', 'icon', '/tt', 0, NULL, '2023-04-09 10:44:10', '2023-04-09 10:49:45', 1);
INSERT INTO `per_menu` VALUES (25, '6', '6', '6', '6', 24, NULL, '2023-04-09 10:49:39', NULL, 0);
...
INSERT INTO `per_role` VALUES (10, '1', '测试', NULL, '2023-04-09 10:28:16', '2023-04-09 10:38:59', 1);
INSERT INTO `per_role` VALUES (11, '6', '6', NULL, '2023-04-09 10:49:14', '2023-04-09 10:49:25', 1);
...
CREATE TABLE `per_role_menu`  (
  ...
  `menu_id` int(0) UNSIGNED NOT NULL COMMENT '菜单id',
  `status` tinyint(0) UNSIGNED NOT NULL DEFAULT 1 COMMENT '0禁用，1正常，默认1',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色菜单关系表' ROW_FORMAT = Dynamic;
...
INSERT INTO `per_role_menu` VALUES (35, 10, 6, 1, '2023-04-09 10:38:55', NULL, 0);
INSERT INTO `per_role_menu` VALUES (36, 10, 3, 1, '2023-04-09 10:38:55', NULL, 0);
INSERT INTO `per_role_menu` VALUES (37, 10, 4, 1, '2023-04-09 10:38:55', NULL, 0);
INSERT INTO `per_role_menu` VALUES (38, 10, 19, 1, '2023-04-09 10:38:55', NULL, 0);
INSERT INTO `per_role_menu` VALUES (39, 10, 14, 1, '2023-04-09 10:38:55', NULL, 0);
INSERT INTO `per_role_menu` VALUES (40, 11, 5, 1, '2023-04-09 10:49:22', NULL, 0);
INSERT INTO `per_role_menu` VALUES (41, 11, 1, 1, '2023-04-09 10:49:22', NULL, 0);
INSERT INTO `per_role_menu` VALUES (42, 11, 2, 1, '2023-04-09 10:49:22', NULL, 0);
INSERT INTO `per_role_menu` VALUES (43, 11, 13, 1, '2023-04-09 10:49:22', NULL, 0);
INSERT INTO `per_role_menu` VALUES (44, 11, 3, 1, '2023-04-09 10:49:22', NULL, 0);
INSERT INTO `per_role_menu` VALUES (45, 11, 6, 1, '2023-04-09 10:49:22', NULL, 0);
...
CREATE TABLE `per_staff_role`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `staff_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '员工id',
...
INSERT INTO `per_staff_role` VALUES (10, 6, 2, 0, '2022-03-20 16:41:12', '2023-04-09 10:49:59', 0);
...
INSERT INTO `per_staff_role` VALUES (13, 8, 3, 1, '2023-04-09 10:39:43', NULL, 0);
INSERT INTO `per_staff_role` VALUES (14, 8, 8, 1, '2023-04-09 10:39:43', NULL, 0);
INSERT INTO `per_staff_role` VALUES (15, 6, 10, 1, '2023-04-09 10:49:59', NULL, 0);
INSERT INTO `per_staff_role` VALUES (16, 6, 4, 1, '2023-04-09 10:49:59', NULL, 0);
INSERT INTO `per_staff_role` VALUES (17, 6, 3, 1, '2023-04-09 10:49:59', NULL, 0);
...
CREATE TABLE `sal_deduct_type`  (
  ...
  `is_deleted` tinyint(0) UNSIGNED NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '扣款类型表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sal_salary`  (
  ...
  `is_deleted` tinyint(0) UNSIGNED NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工工资表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sal_salary_deduct`  (
  ...
  `type_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '扣款类型id',
  `time_limit` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '时间界限',
  `lt_times_limit` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '当小于时间界限时的次数界限',
  ...
  `gt_times_limit` int(0) NULL DEFAULT NULL COMMENT '当大于时间界限时的次数界限',
  ...
  `count_type` tinyint(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0分钟，1小时，2天，默认0，统计的类型，如根据天计算、小时计算、分钟计算',
  `status` tinyint(0) UNSIGNED NOT NULL DEFAULT 1 COMMENT '1启用，0禁用，默认1',
  ...
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '工资扣除表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `soc_city`  (
  ...
  `is_deleted` tinyint(0) UNSIGNED NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '参保城市表' ROW_FORMAT = Dynamic;
...
INSERT INTO `soc_city` VALUES (5, '武汉', 5000.000, 3400.000, 15000.000, 3000.000, 15000.000, 3400.000, 0.100, 0.300, 0.100, 0.130, 0.140, 0.021, 0.025, '2022-03-31 20:02:30', '2023-04-09 10:38:30', 1);
INSERT INTO `soc_city` VALUES (6, '广州', 4000.000, 500.000, 12000.000, 2400.000, 12000.000, 500.000, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, '2023-04-09 10:31:56', '2023-04-09 10:38:30', 1);
INSERT INTO `soc_city` VALUES (7, '广州', 5000.000, 600.000, 15000.000, 3000.000, 15000.000, 600.000, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, '2023-04-09 10:42:22', '2023-04-09 10:42:22', 0);
INSERT INTO `soc_city` VALUES (8, '测试', 6000.000, 4000.000, 18000.000, 3600.000, 18000.000, 4000.000, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, '2023-04-09 10:42:43', '2023-04-09 10:49:02', 1);
INSERT INTO `soc_city` VALUES (9, '测试1', 7001.000, 600.000, 21003.000, 4200.600, 21003.000, 600.000, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, '2023-04-09 10:46:51', '2023-04-09 10:49:02', 1);
...
CREATE TABLE `soc_insurance`  (
  ...
  `status` tinyint(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0未支付，1已支付，2支付失败',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  `is_deleted` tinyint(0) UNSIGNED NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工五险一金表' ROW_FORMAT = Dynamic;
...
INSERT INTO `soc_insurance` VALUES (2, 3, 2, 5001.000, 0.081, 405.081, 0.081, 405.081, 8001.000, 2224.278, 888.111, 0.015, NULL, NULL, 0, '2022-04-06 20:38:41', '2022-04-06 20:38:41', 0);
...
CREATE TABLE `sys_dept`  (
  ...
  `parent_id` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '父级部门id，0根部门',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '逻辑删除，0未删除，1删除',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `sys_dept` VALUES (18, NULL, '测试', NULL, 0, '2023-04-09 10:27:18', '2023-04-09 10:27:30', 1);
INSERT INTO `sys_dept` VALUES (19, NULL, '测试', NULL, 16, '2023-04-09 10:27:53', '2023-04-09 10:41:33', 1);
INSERT INTO `sys_dept` VALUES (20, NULL, '66', NULL, 16, '2023-04-09 10:39:54', '2023-04-09 10:40:31', 1);
INSERT INTO `sys_dept` VALUES (21, NULL, '6', NULL, 16, '2023-04-09 10:50:09', '2023-04-09 10:50:09', 0);
...
CREATE TABLE `sys_docs`  (
  ...
  `size` bigint(0) UNSIGNED NULL DEFAULT NULL COMMENT '文件大小KB',
  `staff_id` int(0) NULL DEFAULT NULL COMMENT '文件上传者id',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '文件备注',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0未删除，1已删除，默认为0',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `sys_docs` VALUES (2, '1837fd34d247d79facff.jpg', 'jpg', 'p8.jpg', '65e9462e351242ecf79a99237d528008', 463, NULL, NULL, '2022-03-31 19:49:24', '2023-04-09 10:39:31', 1);
INSERT INTO `sys_docs` VALUES (3, '9a94569b12454180577a.jpg', 'jpg', '风景图.jpg', 'f00503d69d6c3c72587e744831450e3a', 80, NULL, '66', '2023-04-09 10:26:48', '2023-04-09 10:26:48', 0);
...
CREATE TABLE `sys_staff`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '员工id',
  ...
  `gender` tinyint(0) UNSIGNED NULL DEFAULT 0 COMMENT '性别，0男，1女，默认0',
  ...
  `dept_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '部门id',
  `status` tinyint(0) UNSIGNED NOT NULL DEFAULT 1 COMMENT '员工状态，0异常，1正常',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '逻辑删除，0未删除，1已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_staff
-- ----------------------------
INSERT INTO `sys_staff` VALUES (1, 'admin', 'jack', 0, '202CB7007152D234B962AC59075B964B', '9a94569b12454180577a.jpg', '2000-12-21', '13990849318', '广州', NULL, 2, 1, '2022-01-22 19:46:27', '2023-04-09 10:26:51', 0);
...
INSERT INTO `sys_staff` VALUES (6, 'staff_6', 'harden', 0, '827CE7BA16891F84CB0EEA8A706C4C34', 'avatar.png', '1996-06-01', NULL, NULL, '硕士', 17, 1, '2022-01-27 14:36:17', '2023-04-09 10:50:02', 0);
